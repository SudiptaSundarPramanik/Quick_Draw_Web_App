...
quick_draw_data_set_array=[4];

random_no=Math.floor((Math.random()*quick_draw_data_set.length)+1);
console.log(random_no);
sketch=quick_draw_data_set[random_no];
document.getElementById("nooo").innerHTML="Sketch to be Drawn: "+sketch;
...
function draw(){
    ...
    if(drawn_sketch==sketch){
        answer_holder="set";
        score=score+1;
        document.getElementById("noo").innerHTML="Score: "+score;
    }
}
...
function gotResult(error,results){
    ...
    document.getElementById("ysketch").innerHTML="Your Sketch: "+drawn_sketch;
    document.getElementById("yconfidence").innerHTML=Math.round(results[0].confidence*100)+"%";
}